...
import { DecStyleConfig } from './DecStyleConfig';

const defaultStyle = require('./DefaultStyle.json');

export class DecStyleManager {
    private style: DecStyleConfig;
    private static sharedInstance: DecStyleManager;
    ...
    public static getInstance() {
        if (DecStyleManager.sharedInstance === undefined) {
            DecStyleManager.sharedInstance = new DecStyleManager(defaultStyle as DecStyleConfig);
        }
        return DecStyleManager.sharedInstance;
    }

    public addStyle(overrideStyle: DecStyleConfig): DecStyleConfig {
        return merge(this.style, overrideStyle);
    }

    public getStyle(): DecStyleConfig {
        return this.style;
    }
