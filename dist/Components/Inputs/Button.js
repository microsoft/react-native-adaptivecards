...
export class Button extends React.Component {
    ...
    render() {
        return (React.createElement(Touchable, { testId: this.props.title, onPress: this.props.onPress, disabled: this.props.disabled, accessibilityLabel: this.props.title, style: [
                {
