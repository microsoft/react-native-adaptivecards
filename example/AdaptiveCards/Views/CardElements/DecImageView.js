...
export class DecImageView extends React.PureComponent {
    constructor(props) {
        super(props);
        this.onLayout = (event) => {
    ...
    render() {
        ...
        const borderRadius = element.style === ImageStyle.Person && dimensions ?
            dimensions.width / 2 :
            undefined;
        return (React.createElement(View, { style: DecStyleManager.getInstance().isHorizontalImageSet() ? undefined : { flex: 1 }, onLayout: this.onLayout },
