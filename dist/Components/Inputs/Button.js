...
export class Button extends React.Component {
    ...
    render() {
        return (React.createElement(Touchable, { testId: this.props.title, onPress: this.props.onPress, disabled: this.props.disabled, accessibilityLabel: 'Button ' + this.props.title, style: [
                {
    ...
    renderIcon() {
        if (this.props.icon && this.props.icon.url) {
            if (this.props.icon.type === 'img') {
                return (React.createElement(Image, { url: this.props.icon.url, host: this.props.icon.host, style: {
