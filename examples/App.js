    ...
    render() {
        return (
            <ScrollView style={{
                ...
                <AdaptiveCards adaptiveCard={mockData.list} onSubmit={this.onSubmit} onInfo={this.onInfo} onError={this.onError} onWarning={this.onWarning} onOpenUrl={this.onOpenUrl}/>
                {this.renderGap()}
