...
export class DecCardElementWrapper extends React.PureComponent {
    ...
    renderSeparator(spacing, isHorizontalLayout) {
        return (React.createElement(SeparateLine, { isHorizontal: isHorizontalLayout, margin: DecStyleManager.getInstance().getCardElementMargin(spacing), color: this.styleConfig.element.separateLineColor }));
    }
    onClick() {
