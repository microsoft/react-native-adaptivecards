...
export class FactSetView extends React.Component {
    ...
    render() {
        ...
        return (React.createElement(Column, { vIndex: this.props.vIndex, hIndex: this.props.hIndex, width: 'auto', spacing: StyleManager.getInstance().getSpacing(element.spacing) }, this.renderFacts()));
    }
}
